                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="callout callout-danger" style='margin-top: 30px;'>
                                    <p>Note: You can only add marks for the courses you are teaching</p>
                                </div>
                                <div class="card card-info">
                                    ...
                                    <form action="" class="form-horizontal" method="post" id="mark-add">
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="col-md-3">
                                                    <label for="dept"> Class <span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="subject"> Course<span class="text-danger">*</span></label>
