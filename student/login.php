...
$logo = $details->logo;
$name = $details->varsity_name;
$main_url = 'http://localhost/resultapp';
$footer = $details->footer;



    $login_bg =$main_url."/upload/logobg.png";
            ...
            <div class="card-body">
                ...
                <form action="" method="post" id="login_form">
                    <div class="input-group mb-3">
                        <input type="number" class="form-control" placeholder="Registration Number" name="reg_no">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p> You will need to contact Helpline to issue you a new password</p>

                    <a href="javascript:void" class='btn btn-success'> Contact on: +8802997735008 </a>
                </div>
            </div>
        </div>
    </div>
