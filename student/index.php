...
<head>
    ...
    <title> Student Dashboard | <?php echo $varsity_name; ?></title>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <?php
        $sql = "SELECT name FROM student WHERE reg_no = :r";
        $conn->query($sql);
        $conn->bind(":r", $_SESSION['student']);
        $details = $conn->fetchSingle();
        $Name = $details->name;
                    ?>
                        <h1 class="m-0">Welcome <span style="color: #17a2b8;"><?php echo ucfirst($Name); ?>
                           </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
