...
<head>
    ...
    <title> Add Section | <?php echo $varsity_name; ?></title>
    <style>
                 ...
                 <div class="col-lg-8">
                     <div class="card card-info">
                         <div class="card-header">
                             <h3 class="card-title">Enter details below</h3>
                         </div>

                         <form action="" class="form-horizontal" method="post" id="section-add">
                              <div class="card-body">
                                  <div class="form-group row">
                                      <label for="name" class="col-sm-3 col-form-label">Session <span style="color: #f00;">*</span></label>
                                      <div class="col-sm-9">
                                  ...
                                  <div class="form-group row">
                                      <label for="class" class="col-sm-3 col-form-label">Department <span style="color: #f00;">*</span></label>
                                      <div class="col-sm-9">
...
<script>
    ...
    $('#section-add').on('submit', function(event){
        ...
        if($('#section-add').parsley().isValid()){
            $.ajax({
                url: "<?php echo $base_url; ?>process-add-session.php",
                method: "POST",
