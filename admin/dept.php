...
?>
    ...
    <head>
        ...
        <title> Departments | <?php echo $varsity_name; ?></title>
        <style>
            .parsley-required,
            .parsley-pattern {
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <section class="col-lg-12 connectedSortable">
                                <a href="<?php echo $conn->base_url(); ?>add-dept"> <button class="btn btn-outline-success">Add Department</button></a>
                            </section>
                                            ...
                                            <tbody>
                                                ...
                                                if ($rowCount > 0) {
                                                    foreach ($result as $dept) :
                                                        $name = $dept->dept_name;
                                                        $teacher_name = $dept->chairman_name;
                                                ?>
                                                        <tr>
                                                            <td><?php echo $i++; ?></td>
                                                            <td><?php echo $name; ?></td>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo $base_url; ?>edit-dept" data-toggle="tooltip" title="Edit">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>&nbsp;
                                                                <a href="javascript:void(0);" data-toggle="modal" data-target="#delete-class<?php echo $name; ?>">
            ...
            ?>
                ...
                <div class="modal fade" id="delete-class<?php echo $name; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            if (isset($_POST['delete_class'])) {
                $id = $_POST['id'];
                //sql
                $sql = "DELETE FROM department WHERE dept_name =:id";
                $conn->query($sql);
                $conn->bind(":id", $name);
                ...
                try {
                  ...
                  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                   ...
                   <meta http-equiv='refresh' content='1; dept'>
