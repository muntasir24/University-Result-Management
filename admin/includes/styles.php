...
$conn->query($sql);
$varsity_details = $conn->fetchSingle();
$logo = $varsity_details->logo;
$varsity_name = $varsity_details->varsity_name;
$main_url = $varsity_details->main_url;
$footer = $varsity_details->footer;
global $varsity_name;
