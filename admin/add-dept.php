...
<head>
    ...
    <title> Add Department | <?php echo $varsity_name; ?></title>
    <style>
        .parsley-required,
        .parsley-pattern {
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-lg-8">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">Enter data below</h3>
                                </div>

                                <form action="" class="form-horizontal" method="post" id="dept-add">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-3 col-form-label">Department name <span style="color: #f00;">*</span></label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <label for="teacher_name" class="col-sm-3 col-form-label">Chairman Name</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="submit" name="add_dept" value="Add dept" class="btn btn-info" id="submit">
                                            </div>
                                        </div>
    ...
    <script>
        $('#dept-add').parsley();
        $('#dept-add').on('submit', function(event) {
            event.preventDefault();
            if ($('#dept-add').parsley().isValid()) {
                $.ajax({
                    url: "<?php echo $base_url; ?>process-add-dept.php",
                    method: "POST",
