...
<head>
    ...
    <title> Edit Teacher | <?php echo $varsity_name; ?></title>
    <style>
        .parsley-required,
        .parsley-pattern {
                                        ...
                                        <form action="" class="form-horizontal" method="post" id="teacher-edit">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="name" required data-parsley-trigger="keyup" name="name" value="<?php echo $teacher_name;  ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="dept_name" class="form-control" required data-parsley-trigger="keyup" value="<?php echo $result->dept_name;  ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9" data-toggle="tooltip" title="Username cannot be changed">
                                                        <input style="cursor: not-allowed" type="text" class="form-control" id="username" required name="username" value="<?php echo $result->username;  ?>" readonly>
                                                    </div>
                                                </div>
